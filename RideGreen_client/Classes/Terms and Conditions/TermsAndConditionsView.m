...
//  ridegreendriver
//
//  Created by Ridegreen on 18/10/2015.
...
- (void)viewDidLoad {
    ...
    self.textView.frame = CGRectMake(10,64,self.view.frame.size.width - 20, self.view.frame.size.height-64);
    ...
    @"QUESTIONS:"
    @"\n\n Questions regarding our Conditions of Usage, Privacy Policy, or other policy related material can be directed to our support staff by clicking on the Contact Us link in the side menu. Or you can email us at: info@RideGreen.com";
}
