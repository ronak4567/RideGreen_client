...
const static CGFloat kCustomIOSAlertViewDefaultButtonSpacerHeight = 3;
...
- (void)addButtonsToView: (UIView *)container
{
    ...
    for (int i=0; i<[buttonTitles count]; i++) {
        ...
        [closeButton setBackgroundImage:[UIImage imageNamed:@"reservation.png"] forState:UIControlStateNormal];
        closeButton.layer.cornerRadius = 12.0f;
