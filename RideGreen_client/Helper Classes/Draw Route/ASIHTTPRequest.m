...
///Users/us14/Documents/Desktop/RideGreen PakringAnd tour/RideGreen_client/RideGreen_client/Helper Classes/Draw Route/ASIHTTPRequest.m:3982:66: Null passed to a callee that requires a non-null argument
...
- (void)runPACScript:(NSString *)script
{
	if (script) {
		...
		CFRelease(CFNetworkCopyProxiesForURL((CFURLRef)[self url],defProxyDic));
